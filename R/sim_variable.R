...
##'
##' @export
sim_variable <- function (n, formulas, family, pars, link, dat, quantiles, survival) {
  ## get variables
...
compute_copula_quantiles <- function(qs, family, pars, i, inv, p = FALSE) {
  ...
  copula_functions_p <- list(
    ...
    function(U, param, par2) pCopula(U, copula = normalCopula(param = param, dispstr = "un")),
    ...
    function(U, param, par2) pCopula(U, copula = gumbelCopula(param = param, dim = 2, dispstr = "un")),
    function(U, param, par2) pCopula(U, copula = frankCopula(param = param, dim = 2, dispstr = "un")),
    function(U, param, par2) pCopula(U, copula = joeCopula(param = param, dim = 2, dispstr = "un"))
  )
